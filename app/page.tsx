...
const projects = [
  ...
  },
  {
    ...
    time: "3 месяца",
    price: "5 900 000 ₽",
    image: "/assets/5493ac3df3f43623.JPG",
    note: "Просторный дом с выразительной архитектурой и большой террасой.",
    gallery: ["/assets/5493ac3df3f43623.JPG", "/assets/bda93c2402156afc.JPG", "/assets/c468df4b53a79f01.JPG"],
    ...
    <main>
      ...
      <section className="about section" id="about">
        ...
        <div className="about-copy">
          ...
          <p>Работаем официально по Краснодарскому краю и Республике Адыгея. Доступно проектное финансирование и ипотека без первоначального взноса более чем в 10 банках.</p>
        </div>
      </section>
